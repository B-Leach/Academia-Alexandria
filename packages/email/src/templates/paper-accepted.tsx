...
interface PaperAcceptedEmailProps {
  authorName: string;
  paperTitle: string;
  paperUrl: string;
...
export function PaperAcceptedEmail({
  authorName,
  paperTitle,
  paperUrl,
  reputationEarned,
  unsubscribeUrl,
  settingsUrl,
}: PaperAcceptedEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Your paper has been accepted!</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            ...
            <strong>&quot;{paperTitle}&quot;</strong> has been accepted by the
            community through peer review.
          </Text>
          <Text style={paragraph}>
            You earned <strong>+{reputationEarned} reputation points</strong>{" "}
